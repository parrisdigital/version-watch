...
describe("vendor categories", () => {
  ...
  it("separates browsers, model platforms, coding agents, and web-data tools", () => {
    ...
    expect(getCategoryForSlug("aider")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("amazon-q-developer")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("amp")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("bolt")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("claude-code")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("cline")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("coderabbit")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("continue")).toBe("AI Coding Agents");
    ...
    expect(getCategoryForSlug("openhands")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("qodo")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("replit-agent")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("roo-code")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("sourcegraph-cody")).toBe("AI Coding Agents");
    expect(getCategoryForSlug("tabnine")).toBe("AI Coding Agents");

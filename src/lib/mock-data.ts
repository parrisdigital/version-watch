...
export const vendors: VendorRecord[] = [
  ...
  },
  {
    ...
    sources: [
      { name: "API Release Notes", url: "https://docs.anthropic.com/en/release-notes/api", type: "docs_page" },
      { name: "Product Release Notes", url: "https://support.anthropic.com/en/articles/12138966-release-notes", type: "changelog_page" },
    ],
  },
  {
    slug: "gemini",
  ...
  },
  {
    ...
    sources: [{ name: "GitHub Changelog", url: "https://github.blog/changelog/", type: "blog" }],
  },
  {
    slug: "cloudflare",
    name: "Cloudflare",
    description: "Workers, networking, storage, and platform changes.",
    sources: [{ name: "Cloudflare Changelog", url: "https://developers.cloudflare.com/changelog/", type: "changelog_page" }],
  },
  {
    slug: "cursor",
    name: "Cursor",
  ...
  },
  {
    ...
    sources: [{ name: "Firebase Release Notes", url: "https://firebase.google.com/support/release-notes", type: "docs_page" }],
  },
  {
    slug: "apple-developer",
    name: "Apple Developer",
    description: "Xcode and Apple platform release notes.",
    sources: [{ name: "Xcode Release Notes", url: "https://developer.apple.com/documentation/xcode-release-notes/", type: "docs_page" }],
  },
  {
    slug: "android-developers",
    name: "Android Developers",
    description: "Android platform release notes and API changes.",
    sources: [{ name: "Android Release Notes", url: "https://developer.android.com/about/versions/17/release-notes", type: "docs_page" }],
  },
  {
    slug: "firecrawl",
    name: "Firecrawl",
...
const eventSeeds: Array<Omit<MockEvent, "vendorName">> = [
  ...
  },
  {
    ...
    sourceUrl: "https://developer.apple.com/documentation/xcode-release-notes/",
    sourceType: "docs_page",
    importanceBand: "high",
  },
  {
    ...
    sourceUrl: "https://developer.android.com/about/versions/17/release-notes",
    sourceType: "docs_page",
    importanceBand: "critical",
  },
  {
...
export const sourceHealth: SourceHealthEntry[] = [
  ...
  { vendorName: "Anthropic", sourceName: "API Release Notes", status: "healthy", lastSuccessAt: "2026-04-18T17:00:00.000Z" },
  ...
  { vendorName: "Apple Developer", sourceName: "Xcode Release Notes", status: "degraded", lastSuccessAt: "2026-04-17T12:00:00.000Z" },
  { vendorName: "Android Developers", sourceName: "Android Release Notes", status: "healthy", lastSuccessAt: "2026-04-18T06:00:00.000Z" },
  { vendorName: "Firebase", sourceName: "Firebase Release Notes", status: "healthy", lastSuccessAt: "2026-04-18T04:00:00.000Z" },
  { vendorName: "Docker", sourceName: "Docker Desktop Release Notes", status: "failing", lastSuccessAt: "2026-04-16T21:15:00.000Z" },
];
